...
if (isset($_POST['submit'])) {
        ...
        if (!isset($_POST['CSRFName']) or !isset($_POST['CSRFToken']) ) {
                ...
                $tool_content .= "<a href='infocours.php'>$langBack</a></p>";
                $tool_content .= "<p>&nbsp;</p>";
                draw($tool_content, 3, 'admin');
                exit();
        }elseif (!validateCsrfToken($_POST['CSRFName'], $_POST['CSRFToken'])) { 
                //$tool_content .="<p class='caution_small'>$langError<br /><a href='group.php>$langBack</a></p><br />";
                $tool_content .= "<p class='caution_small'>$langError<br />";
                $tool_content .= "<a href='infocours.php'>$langBack</a></p>";
                $tool_content .= "<p>&nbsp;</p>";
                draw($tool_content, 3, 'admin');
		...
		<tr>
			...
			<td>
                        <input type='text' name='titulary' value='$titulary' size='60' class='FormData_InputText' />
                        $token
                        </td>
		<td>&nbsp;</td>
		</tr>
