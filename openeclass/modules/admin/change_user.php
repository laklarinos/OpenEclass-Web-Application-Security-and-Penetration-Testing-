...
if (isset($_POST['username'])) {
		...
		$tool_content = "<div class='caution_small'>" . sprintf($langError) . "</div>";
		$tool_content .= "<a href='change_user.php'>$langBack</a></p>";
		$tool_content .= "<p>&nbsp;</p>";
...
$tool_content .= 
"<form action='$_SERVER[PHP_SELF]' method='post'>$langUsername: 
