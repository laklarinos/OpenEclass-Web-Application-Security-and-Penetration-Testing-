...
if (isset($_POST['back1']) or !isset($_POST['visit'])) {
   ...
   // display form
	...
	<td width=\"160\">
	<input class='FormData_InputText' type='text' name='intitule' size='60' value='".@$intitule."' />
	$token
	</td>
...
// --------------------------------
 ...
 elseif (isset($_POST['create2']) or isset($_POST['back2']))  {
	...
	<th>&nbsp;</th>
	<td>
	<input type='submit' name='back1' value='< $langPreviousStep ' />&nbsp;<input type='submit' name='create3' value='$langNextStep >' />
	$token
	</td>
	</tbody>
	</table>
...
if (isset($_POST['create_course'])) {
	...
	if (! isset($_POST['CSRFName']) or ! isset($_POST['CSRFToken'])){
		...
		$tool_content .= "<a href='create_course.php'>$langBack</a></p>";
      	$tool_content .= "<p>&nbsp;</p>";
